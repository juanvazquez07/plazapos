...
Route::get('/products/{product}/decrement', [ProductController::class, 'decrement'])->name('products.decrement');
Route::get('/products/{product}/increment', [ProductController::class, 'increment'])->name('products.increment');
