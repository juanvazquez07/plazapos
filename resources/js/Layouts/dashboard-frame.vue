<template>
    <div class="flex flex-row">
        <div class="flex flex-col basis-1/5 px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
    ...
    <div class="flex-col basis-4/5 justify-end">
        <nav class=" flex-row h-13 w-page bg-white shadow dark:bg-gray-800">
            <div class="container px-6 py-4 mx-auto">
                <div class="md:flex md:items-center md:justify-between">
                    ...
                    <div class="flex-1 md:flex md:items-center ">
                        ...
                        <div class="flex items-center mt-4 md:mt-0 justify-end">
        ...
        <div class="px-5 py-5 flex-col h-80">
            <h1>Hola mundo</h1>
        </div>
    </div>
