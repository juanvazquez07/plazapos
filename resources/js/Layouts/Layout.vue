<template>
    <div class="flex">
        <transition name="slide">   
            <div v-if="show" class="w-64  bg-blue-500 h-screen" ><!--:class="{'w-0 ': showSidebar}"-->
                <div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
                    <div class="relative mt-6 flex" >
                        <img class="object-cover w-12 h-12 mx-2 rounded-full" src="https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80" alt="avatar">
                    ...
                    <div class="flex flex-col justify-between flex-1 mt-6">
                        <nav>
                            <a @click="inicio()" class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                            ...
                            <a :href="route('products.index')" :active="route().current('products.index')" class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                            ...
                            <a :href="route('categories.index')" :active="route().current('categories.index')" class=" active:bg-violet-700 flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>

                                <span class="mx-4 font-medium">Categorias</span>
                            </a>

                            <a :href="route('brands.index')" :active="route().current('brands.index')" class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                        ...
                        <div class="md:flex md:items-center md:justify-between">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-xl font-semibold text-gray-700">
                                    <strong>Sistema de inventario  </strong>{{currentDate("day")}} de {{convertMonth(currentDate("month"))}} de {{currentDate("year")}}
                                </div>
                            ...
                            <div class="flex-1 md:flex md:items-center  justify-end">
                                <div class="flex items-center mt-4 md:mt-0">
                                    ...
                                    <div class="relative inline-block ">
                                        ...
                                        <!-- Dropdown menu -->
                                        <div  v-if="isOpen" class="absolute right-0 z-20 w-56 py-2 mt-2 overflow-hidden bg-white rounded-md shadow-xl dark:bg-gray-800">
                                            ...
                                            <a href="#" @click="logout()" as="button" class="flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-200 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
                                                <svg class="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
